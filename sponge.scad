...
z=0;
//start of layer
translate([x,y,z+2*size]) sponge4(size/3);
translate([x,y,z+size]) sponge4(size/3);
translate([x,y,z]) sponge4(size/3);
translate([x,y+size,z+2*size]) sponge4(size/3);
//translate([1,1,1]) cube([1,1,1]);
translate([x,y+size,z]) sponge4(size/3);
translate([x,y+2*size,z+2*size]) sponge4(size/3);
translate([x,y+2*size,z+size]) sponge4(size/3);
translate([x,y+2*size,z]) sponge4(size/3);
// end of layer
translate([x+size,y,z]) sponge4(size/3);
translate([x+size,y+2*size,z+2*size]) sponge4(size/3);
translate([x+size,y,z+2*size]) sponge4(size/3);
translate([x+size,y+2*size,z]) sponge4(size/3);
//start of layer
translate([x+2*size,y,z+2*size]) sponge4(size/3);
translate([x+2*size,y,z+size]) sponge4(size/3);
translate([x+2*size,y,z]) sponge4(size/3);
translate([x+2*size,y+size,z+2*size]) sponge4(size/3);
//translate([-1,1,1]) cube([1,1,1]);
translate([x+2*size,y+size,z]) sponge4(size/3);
translate([x+2*size,y+2*size,z+2*size]) sponge4(size/3);
translate([x+2*size,y+2*size,z+size]) sponge4(size/3);
translate([x+2*size,y+2*size,z]) sponge4(size/3);
// end of layer
}
